...
TOKEN = '7808370111:AAFuQTNTL17dsBl3mSH6p0HdQ0xOj2Vs6Wk'
MONGO_URI = 'mongodb+srv://rishi:ipxkingyt@rishiv.ncljp.mongodb.net/?retryWrites=true&w=majority&appName=rishiv'
FORWARD_CHANNEL_ID = -1002350851907
CHANNEL_ID = -1002350851907
error_channel_id = -1002350851907
...
def create_inline_keyboard():
    ...
    button3 = types.InlineKeyboardButton(
        text="🔥 𝗝𝗼𝗶𝗻 𝗚𝗼𝗗𝘅𝗟𝗲𝗴𝗲𝗻𝗱 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 🔥", url="https://t.me/+rzj8IlSLrB04YmI1")
    button1 = types.InlineKeyboardButton(text="👤 𝗖𝗼𝗻𝘁𝗮𝗰𝘁 𝗢𝘄𝗻𝗲𝗿 👤",
        url="https://t.me/GoDxLegendOpB")
    markup.add(button3)
    markup.add(button1)
    return markup
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"
                                       ...
                                       "*Contact the owner for assistance: @GoDxLegendOpB.*", 
                                       reply_markup=create_inline_keyboard(), parse_mode='Markdown')
            return
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*🚀 GoDxLegend Attack Initiated! 🚀*\n\n"
                                           f"*📡 Target Host: {target_ip}*\n"
                                           f"*👉 Target Port: {target_port}*\n"
                                           f"*⏰ Duration: {duration} seconds! Let the chaos Battlefield! 🔥*", 
                                           reply_markup=create_inline_keyboard(), parse_mode='Markdown')
    ...
    try:
        ...
        if not user_data:
            ...
            button2 = types.InlineKeyboardButton(
                text="💸 𝗣𝗿𝗶𝗰𝗲 𝗟𝗶𝘀𝘁 💸", url="https://t.me/GoDxLegendOpB")
            markup.add(button1)
            markup.add(button2)
        else:
            ...
            button = types.InlineKeyboardButton(
                text="🔥 𝗝𝗼𝗶𝗻 𝗚𝗼𝗗𝘅𝗟𝗲𝗴𝗲𝗻𝗱 𝗖𝗵𝗮𝗻𝗻𝗲𝗹 🔥", url="https://t.me/GoDxLegendOpB")
            markup.add(button)
...
def canary_command(message):
    ...
    button1 = types.InlineKeyboardButton(
        ...
        url="https://t.me/c/2222294117/30")
    button2 = types.InlineKeyboardButton(
